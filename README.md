...
### 该包在`overtrue/socialite` 基础上修改 新增`line`登录 
...
use Ezreal\Socialite\SocialiteManager;
...
$user->getId();        // 1472352
$user->getNickname();  // "Ezreal"
$user->getUsername();  // "Ezreal"
$user->getName();      // "安正超"
...
`facebook`, `line`, `github`, `google`, `linkedin`, `outlook`, `weibo`, `taobao`, `qq`, `wechat`, `douyin`, and `douban`.
...
```json
{
  ...
  "original": {
    ...
    "gravatar_id": "",
    "url": "https://api.github.com/users/Ezreal",
    "html_url": "https://github.com/Ezreal",
    ...
  },
  "token": {
